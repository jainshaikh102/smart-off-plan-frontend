      ...
      <section className="section-padding bg-[#8b7355] text-white">
        <div className="container">
          ...
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-white mb-6">Property Management</h1>
            <p className="text-tan text-xl leading-relaxed">
              Professional property management services to maximize your
              investment returns and ensure hassle-free ownership.
            </p>
          </div>
        </div>
      </section>
