      ...
      <div className="bg-white border-b border-[#8b7355]/10">
        <div className="container py-4">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[#8b7355]">Market Analysis</span>
          </div>
        </div>
      </div>
      ...
      <section className="section-padding bg-gradient-to-br from-beige to-ivory">
        <div className="container">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-[#8b7355] mb-6">Market Analysis</h1>
            <p className="text-warm-gray text-xl leading-relaxed">
              Comprehensive market insights and analysis to help you make
              informed investment decisions in Dubai's real estate market.
            </p>
          </div>
        </div>
      </section>
